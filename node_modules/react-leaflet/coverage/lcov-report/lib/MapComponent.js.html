...
<html lang="en">
<head>
    <title>Code coverage report for lib/MapComponent.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/MapComponent.js</span></h1>
    <h2>
        Statements: <span class="metric">87.65% <small>(71 / 81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">61.36% <small>(27 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">85.71% <small>(18 / 21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.07% <small>(51 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; MapComponent.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_Component != null) {
...
&nbsp;
  _createClass(MapComponent, [{
    ...
    value: <span class="fstat-no" title="function not covered" >function getLeafletElement() {</span>
<span class="cstat-no" title="statement not covered" >      return this.leafletElement;</span>
    }
  }, {
    ...
    value: function extractLeafletEvents(props) {
      return (0, _lodashCollectionReduce2['default'])((0, _lodashObjectKeys2['default'])(props), function (res, ev) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (EVENTS_RE.test(ev)) {
    ...
    value: function bindLeafletEvents() {
      var next = arguments[0] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>: arguments[0];
      var prev = arguments[1] === undefined ? {} : arguments[1];
&nbsp;
      var el = this.leafletElement;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!el) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
      var diff = (0, _lodashLangClone2['default'])(prev);
      (0, _lodashCollectionForEach2['default'])(prev, function (cb, ev) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!next[ev] || cb !== next[ev]) {
          delete diff[ev];
          el.off(ev, cb);
        }
      });
&nbsp;
      (0, _lodashCollectionForEach2['default'])(next, function (cb, ev) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!prev[ev] || cb !== prev[ev]) {
          diff[ev] = cb;
          el.on(ev, cb);
        }
      });
&nbsp;
    ...
    value: function fireLeafletEvent(type, data) {
      var el = this.leafletElement;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (el) el.fire(type, data);
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >      var el = this.leafletElement;</span>
<span class="cstat-no" title="statement not covered" >      if (!el) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      (0, _lodashCollectionForEach2['default'])(this._leafletEvents, <span class="fstat-no" title="function not covered" >function (cb, ev) {</span></span>
<span class="cstat-no" title="statement not covered" >        el.off(ev, cb);</span>
      });
    }
  }]);
&nbsp;
