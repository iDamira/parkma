...
<html lang="en">
<head>
    <title>Code coverage report for lib/MapLayer.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">lib/MapLayer.js</span></h1>
    <h2>
        Statements: <span class="metric">77.63% <small>(59 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">52.94% <small>(18 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">92.31% <small>(12 / 13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.75% <small>(30 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; MapLayer.js</div>
</div>
<div class="body">
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (_MapComponent != null) {
...
<span class="cstat-no" title="statement not covered" >      _get(Object.getPrototypeOf(MapLayer.prototype), 'componentWillUnmount', this).call(this);</span>
<span class="cstat-no" title="statement not covered" >      this.props.map.removeLayer(this.leafletElement);</span>
    }
  }, {
...
&nbsp;
      return _react2['default'].Children.map(children, function (child) {
        return child ? _react2['default'].cloneElement(child, props) : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
      });
    }
  }]);
&nbsp;
